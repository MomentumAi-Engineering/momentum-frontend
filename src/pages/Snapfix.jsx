      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 transform ${
          ...
          <div className="relative group">
            ...
            {/* Main card */}
            <div className="relative bg-black backdrop-blur-xl border border-gray-800 rounded-3xl p-12 lg:p-16 shadow-2xl">
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  <button className="group relative inline-flex items-center px-8 py-4 bg-white text-black rounded-2xl font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-white/25 hover:scale-105 transform">
