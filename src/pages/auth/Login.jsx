...
export default function Login() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f1115] px-4">
      <div className="bg-[#16181d] shadow-lg rounded-2xl p-10 w-full max-w-md text-white">
        <h2 className="text-3xl font-semibold mb-6 text-white">Log into your account</h2>
        ...
        <p className="mt-4 text-xs text-center text-gray-500">
          ...
          and{" "}
          <a href="/signup" className="underline hover:text-gray-400">
            Privacy Policy
          </a>.
        </p>
      </div>
